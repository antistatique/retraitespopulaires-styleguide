...
module.exports = function() {
  ...
  gulp.task('styles:lint', function() {
    return gulp.src([config.assets + 'sass/**/*.s+(a|c)ss', '!' + config.assets + 'sass/+(bootstrap-variables|bootstrap|main|styleguide|styleguide-variables|main-variables|_mixins|'+config.iconsFontName+').scss', '!' + config.assets + 'sass/organisms/_photoswipes.scss'])
        .pipe($.plumber({errorHandler: errorAlert}))
        .pipe($.stylelint({
          reporters: [

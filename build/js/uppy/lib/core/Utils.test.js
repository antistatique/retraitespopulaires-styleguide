...
describe('core/utils', function () {
  ...
  describe('settle', function () {
    it('should resolve even if all input promises reject', function () {
      return expect(_Utils2.default.settle([_Promise.reject(new Error('oops')), _Promise.reject(new Error('this went wrong'))])).resolves.toMatchObject({
        successful: [],
    ...
    it('should resolve with an object if some input promises resolve', function () {
      return expect(_Utils2.default.settle([_Promise.reject(new Error('rejected')), _Promise.resolve('resolved'), _Promise.resolve('also-resolved')])).resolves.toMatchObject({

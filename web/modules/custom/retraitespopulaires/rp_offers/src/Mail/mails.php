...
function rp_offers_mail($key, &$message, $params) {
  ...
  switch ($key) {
    ...
    case 'admin':
      ...
      $message['body'][] = Markup::create(t('E-mail: @email', ['@email' => $params['request']->email->value]) . '<br />');
      $message['body'][] = Markup::create(t('Etat civil: @civil_state', ['@civil_state' => $params['request']->civil_state->value]) . '<br />');
      $message['body'][] = Markup::create(t('Prénom: @firstname', ['@firstname' => $params['request']->firstname->value]) . '<br />');
      $message['body'][] = Markup::create(t('Nom: @lastname', ['@lastname' => $params['request']->lastname->value]) . '<br />');
      $message['body'][] = Markup::create(t('Adresse: @address', ['@address' => $params['request']->address->value]) . '<br />');
      $message['body'][] = Markup::create(t('Npa: @zip', ['@zip' => $params['request']->zip->value]) . '<br />');
      $message['body'][] = Markup::create(t('Ville: @city', ['@city' => $params['request']->city->value]) . '<br />');

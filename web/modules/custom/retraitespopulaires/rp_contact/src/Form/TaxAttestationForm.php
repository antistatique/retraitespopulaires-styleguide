...
class TaxAttestationForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $params = NULL) {
    ...
    $form['#attached'] = [
      'library' => ['rp_contact/contact_tax_attestation_form'],
    ];
    ...
    $form['building']['policy'] = [
      '#title'       => $this->t('Votre numéro de prêt ou crédit de construction'),
    ...
    $form['more']['year'] = [
      '#title'       => $this->t("Recevoir le décompte pour l'année *"),
      '#placeholder' => $this->t('2000'),
      '#type'        => 'textfield',
      '#attributes'  => ['size' => 10],
      '#required'    => FALSE,
      '#prefix'      => '<div class="form-group ' . $error_class . '">',
